...
<!-- Delete Review Modal -->
<div id="deleteReviewModal" class="fixed inset-0 bg-black/60 hidden flex justify-center items-center z-50">
<div class="bg-slate-800 p-6 rounded-xl w-80 text-center shadow-xl">
<h2 class="text-xl font-bold mb-4 text-white">Delete Review?</h2>
<p class="text-gray-300 mb-6">Are you sure you want to delete this review? This action cannot be undone.</p>
<div class="flex gap-4 justify-center">
    <button id="cancelDeleteReview" class="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-500 transition font-semibold">Cancel</button>
    <button id="confirmDeleteReview" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition font-semibold">Delete</button>
</div>
</div>
</div>
...
const body = new URLSearchParams();
body.append("review_id", reviewToDelete);
